...
diabetes_model=pickle.load(open(r"trainingModels\diabetes_model.sav",'rb'))
heart_model=pickle.load(open(r"trainingModels\heart_model.sav",'rb'))
parkinsons_model=pickle.load(open(r"trainingModels\parkinsons_model.sav",'rb'))
